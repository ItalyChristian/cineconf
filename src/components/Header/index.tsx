...
export const Header = ({ links }: MenuProps) => {
  ...
  return (
    <header
      ...
      } ${isBanner ? styles.transparent : styles.withBackground}`}
    >
      <div>
        {visible ? (
          <button
          ...
          >
            <X className={styles.icon} style={{ color: burgerColor }} />
          </button>
        ) : (
          <button
          ...
          >
            <Menu className={styles.icon} style={{ color: burgerColor }} />
          </button>
        )}
      </div>
